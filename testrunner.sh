...
# 
# In general, while working on the project, I use something similar to
# https://github.com/cespare/reflex to run the tests passively while I make
# changes. From this working directory, I can run:
# 
# $ reflex bash runtests.sh
# 
# This will watch for any file modifications in the project, and re-run the
# tests (and possibly commit the code) when they occur (wow such TDD)
# 
